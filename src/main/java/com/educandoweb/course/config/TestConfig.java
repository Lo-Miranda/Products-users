...
public class TestConfig implements CommandLineRunner{
    ...
    public void run(String... args) throws Exception{
        ...
        //instancia objetos da Category
        Category cat1 = new Category(null, "Electronics");
        Category cat2 = new Category(null, "Books");
        Category cat3 = new Category(null, "Computers");

        //instancia objetos do Product
        ...
        //salva objetos da Category
        categoryRepository.saveAll(Arrays.asList(cat1, cat2, cat3));
        //salva objetos do Product
        productsRepository.saveAll(Arrays.asList(p1, p2, p3, p4, p5));

        //associa objetos do Product com os da Category
        ...
        //instancia objetos users
        User u1 = new User(null, "Maria Brown", "maria@gmail.com", "988888888", "123456");
        User u2 = new User(null, "Alex Green", "alex@gmail.com", "977777777", "123456");

        //instancia objetos orders
